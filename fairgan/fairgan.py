...
def trainFairGan(dataloader, d1_input_size, d2_input_size, autoencoder_input_size, output_size, autoencoder_latent_size=128, generator_latent_size=128, epochs=4000, normalEpochs=2000, lam=1, verbose=False):
    # Initialize models
...
def trainAutoEncoder(autoencoder, dataloader, epochs=200, verbose=False):
